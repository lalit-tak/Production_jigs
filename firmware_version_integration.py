...
def check_firmware_version(com_port, serial_number, expected_version):
    ...
    try:
        ...
        if not com.open():
            return (serial_number, False, None, expected_version)
                ...
                if response:
                    ...
                    if firmware_version:
                        ...
                        if version_str == expected_version:
                            ...
                            print(f"❌ Firmware version mismatch for {serial_number}! Actual: {version_str} Expected: {expected_version}")
                    else:
        ...
        return (serial_number, result, version_str, expected_version)
    except Exception as e:
