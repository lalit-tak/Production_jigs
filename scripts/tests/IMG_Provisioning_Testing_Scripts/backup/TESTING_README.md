...
```Python
python3 test.py --serial_port /dev/ttyUSB0  --encryption_key 33333333333333333333333333333333 --authentication_key 44444444444444444444444444444444 --network_address 0xF0EE0F --network_channel 1 --test_router_address 1
```
...
```Python
python3 test.py --serial_port /dev/ttyUSB0 @testing_parameters
```
