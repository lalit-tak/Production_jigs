...
|Parameter|Description|Example|
|-|-|-|
|`--sim_selection`|SIM selection behavior.|`--sim_selection "dual_prefer_sim1" or --sim_selection "dual_prefer_sim2" or --sim_selection "single_sim1" or --sim_selection "single_sim2"`|
...
|`--sim2_apn`|SIM2 APN.|`--sim2_apn "internet2"`|
|`--sim2_username`|SIM2 username.|`--sim2_username "user2"`|
|`--sim2_password`|SIM2 password.|`--sim2_password "password2"`|
|`--sim2_pdp_type`|SIM2 PDP type.|`--sim2_pdp_type "IPv6"`|
|`--sim2_pin`|SIM2 PIN.|`--sim2_pin "5678"`|
|`--sim2_puk`|SIM2 PUK.|`--sim2_puk "87654321"`|
|`--cellular_band_lock`|Cellular band lock. (A maximum of 5 bands can be specified.)|`--cellular_band_lock b1,b3,b5,b40,b41`|
...
#--sink_address 1
--sim_selection dual_prefer_sim1
--sim1_apn internet
--sim1_username user
