...
from scripts.Automation.BDaq.BDaqApi import TAiCtrlBase, TArray
from scripts.Automation.BDaq.AiFeatures import AiFeatures
from scripts.Automation.BDaq.AiChannel import AiChannel
