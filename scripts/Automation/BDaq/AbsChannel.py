...
from scripts.Automation.BDaq.BDaqApi import TAbsChannel, BioFailed
from scripts.Automation.BDaq import ErrorCode, CodingType, Baudrate, ErrorRetType, ActiveSignal, OutSignalType
